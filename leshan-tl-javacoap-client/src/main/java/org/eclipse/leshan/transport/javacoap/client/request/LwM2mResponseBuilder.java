...
import static org.eclipse.leshan.transport.javacoap.request.ResponseCodeUtil.toLwM2mResponseCode;
...
public class LwM2mResponseBuilder<T extends LwM2mResponse> implements UplinkRequestVisitor {
    ...
    public LwM2mResponseBuilder(CoapResponse coapResponse) {
    ...
    public void visit(RegisterRequest request) {
        if (coapResponse.getCode().getHttpCode() >= 400) {
            ...
            lwM2mresponse = RegisterResponse.success(coapResponse.options().getLocationPath());
        } else {
    ...
    public void visit(DeregisterRequest request) {
        ...
        if (coapResponse.getCode().getHttpCode() >= 400) {
            // handle error response:
            lwM2mresponse = new DeregisterResponse(toLwM2mResponseCode(coapResponse.getCode()), null,
                    coapResponse.getPayloadString());
