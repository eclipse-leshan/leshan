...
public class LwM2mNodeEncoderTest {
    ...
    public void json_encode_device_object_instance() {
        ...
        String expected = "{" + "\"e\":[" + "{" + "\"n\":\"0\"," + "\"sv\":\"Open Mobile Alliance\"" + "}," + "{"
                + "\"n\":\"1\"," + "\"sv\":\"Lightweight M2M Client\"" + "}," + "{" + "\"n\":\"2\","
                + "\"sv\":\"345000123\"" + "}," + "{" + "\"n\":\"3\"," + "\"sv\":\"1.0\"" + "}," + "{"
                + "\"n\":\"6/0\"," + "\"v\":1" + "}," + "{" + "\"n\":\"6/1\"," + "\"v\":5" + "}," + "{"
                + "\"n\":\"7/0\"," + "\"v\":3800" + "}," + "{" + "\"n\":\"7/1\"," + "\"v\":5000" + "}," + "{"
                + "\"n\":\"8/0\"," + "\"v\":125" + "}," + "{" + "\"n\":\"8/1\"," + "\"v\":900" + "}," + "{"
                + "\"n\":\"9\"," + "\"v\":100" + "}," + "{" + "\"n\":\"10\"," + "\"v\":15" + "}," + "{"
                + "\"n\":\"11/0\"," + "\"v\":0" + "}," + "{" + "\"n\":\"13\"," + "\"v\":1367491215" + "}," + "{"
                + "\"n\":\"14\"," + "\"sv\":\"+02:00\"" + "}," + "{" + "\"n\":\"15\"," + "\"sv\":\"U\"}" + "]" + "}";
