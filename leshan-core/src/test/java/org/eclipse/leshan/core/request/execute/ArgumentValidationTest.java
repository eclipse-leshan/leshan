...
public class ArgumentValidationTest {
    ...
    public static Collection<?> linkValueListProvider() {
        return Arrays.asList( //
                ...
                new TestParams(1, "!" + new String(new byte[] { 0x23, 0x26, 0x28, 0x5B, 0x5D, 0x7E }, StandardCharsets.UTF_8), null), //
                new TestParams(1, new String(new byte[] { 0x22 }, StandardCharsets.UTF_8), InvalidArgumentException.class), // " character
                new TestParams(1, new String(new byte[] { 0x27 }, StandardCharsets.UTF_8), InvalidArgumentException.class), // ' character
                new TestParams(1, new String(new byte[] { 0x5C }, StandardCharsets.UTF_8), InvalidArgumentException.class), // \ character
                new TestParams(1, new String(new byte[] { 0x7F }, StandardCharsets.UTF_8), InvalidArgumentException.class), // DEL character
    ...
    private static class TestParams {
        ...
        public String toString() {
            if (exception != null) {
                return "new Argument(" + digit + ", \"" + value + "\"): expects " + exception.getSimpleName() + " exception";
            } else {
