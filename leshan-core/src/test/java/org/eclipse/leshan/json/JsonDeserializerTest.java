...
public class JsonDeserializerTest {
    ...
    public void deserialize_device_object() throws LwM2mJsonException {
        ...
        String dataString = "{" + "\"e\":[" + "{" + "\"n\":\"0\"," + "\"sv\":\"Open Mobile Alliance\"}," + "{"
                + "\"n\":\"1\"," + "\"sv\":\"Lightweight M2M Client\"}," + "{" + "\"n\":\"2\","
                + "\"sv\":\"345000123\"}," + "{" + "\"n\":\"3\"," + "\"sv\":\"1.0\"}," + "{" + "\"n\":\"6/0\","
                + "\"v\":1" + "}," + "{" + "\"n\":\"6/1\"," + "\"v\":5" + "}," + "{" + "\"n\":\"7/0\"," + "\"v\":3800"
                + "}," + "{" + "\"n\":\"7/1\"," + "\"v\":5000" + "}," + "{" + "\"n\":\"8/0\"," + "\"v\":125" + "},"
                + "{" + "\"n\":\"8/1\"," + "\"v\":900" + "}," + "{" + "\"n\":\"9\"," + "\"v\":100" + "}," + "{"
                + "\"n\":\"10\"," + "\"v\":15" + "}," + "{" + "\"n\":\"11/0\"," + "\"v\":0" + "}," + "{"
                + "\"n\":\"13\"," + "\"v\":1367491215" + "}," + "{" + "\"n\":\"14\"," + "\"sv\":\"+02:00\"" + "},"
                + "{" + "\"n\":\"15\"," + "\"sv\":\"U\"}" + "]" + "}";
    ...
    public void deserialize_temperature_resource() throws LwM2mJsonException {
        ...
        String dataString = "{" + "\"e\":[" + "{" + "\"n\":\"1/2\"," + "\"v\":22.4" + "," + "\"t\":-5" + "}," + "{"
                + "\"n\":\"1/2\"," + "\"v\":22.9" + "," + "\"t\":-30" + "}," + "{" + "\"n\":\"1/2\"," + "\"v\":24.1"
                + "," + "\"t\":-50" + "}" + "]" + "," + "\"bt\":25462634" + "}";
    ...
    public void deserialize_baseNameSpecified_object() throws LwM2mJsonException {
        ...
        String dataString = "{" + "\"bn\":\"/\"," + "\"e\":[" + "{" + "\"n\":\"A/0/0/0\"," + "\"ov\":\"B:0\"}," + "{"
                + "\"n\":\"A/0/0/1\"," + "\"ov\":\"B:1\"" + "}," + "{" + "\"n\":\"A/0/1\","
                + "\"sv\":\"8613800755500\"}," + "{" + "\"n\":\"A/0/2\"," + "\"v\":1" + "}," + "{" + "\"n\":\"B/0/0\","
                + "\"sv\":\"myService1\"}," + "{" + "\"n\":\"B/0/1\"," + "\"sv\":\"Internet.15.234\"}," + "{"
                + "\"n\":\"B/0/2\"," + "\"ov\":\"C:0\"}," + "{" + "\"n\":\"B/1/0\"," + "\"sv\":\"myService2\"}," + "{"
                + "\"n\":\"B/1/1\"," + "\"sv\":\"Internet.15.235\"}," + "{" + "\"n\":\"B/1/2\","
                + "\"ov\":\"FFFF:FFFF\"}," + "{" + "\"n\":\"C/0/0\"," + "\"sv\":\"85.76.76.84\"}," + "{"
