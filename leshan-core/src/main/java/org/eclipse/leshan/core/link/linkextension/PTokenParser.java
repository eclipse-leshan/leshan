...
/**
 * A CoRE Link PToken parser interface defined in RFC6690 (https://datatracker.ietf.org/doc/html/RFC6690#section-2).
 */
public interface PTokenParser extends Parser<LinkParamValue> {
}
