...
public final class ULong extends Number implements Comparable<ULong> {
    ...
    /**
     * A constant holding the maximum value + 1 an <code>signed long</code> can have as ULong, 2<sup>63</sup>.
     */
     ...
     *
     * @throws NumberFormatException If <code>value</code> does not contain a parsable <code>unsigned long</code>.
     */
     ...
     * Create an <code>unsigned long</code>
     *
     * @throws NumberFormatException If <code>value</code> is not in the range of an <code>unsigned long</code>
     */
