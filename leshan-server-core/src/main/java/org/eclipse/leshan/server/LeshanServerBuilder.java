...
public class LeshanServerBuilder {
    ...
    private LwM2mEndpointsProvider endpointProvider;
    ...
    public LeshanServerBuilder setEndpointProvider(LwM2mEndpointsProvider endpointProvider) {
     ...
     *
     * @see LeshanServer#LeshanServer(LwM2mEndpointsProvider, RegistrationStore, SecurityStore, Authorizer,
     ...
     */
    protected LeshanServer createServer(LwM2mEndpointsProvider endpointsProvider, RegistrationStore registrationStore,
