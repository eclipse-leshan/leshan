...
public class LeshanServer implements LwM2mServer {
     ...
     *
     * @param endpointsProvider which will create all available {@link LwM2mEndpoint}
     ...
     * @since 1.1
     */
    public LeshanServer(LwM2mEndpointsProvider endpointsProvider, RegistrationStore registrationStore,
    ...
    public LwM2mEndpoint getEndpoint(Protocol protocol) {
        for (LwM2mEndpoint endpoint : endpointsProvider.getEndpoints()) {
