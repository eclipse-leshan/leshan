...
class RequestSendingTask implements Runnable {
     ...
     */
    public RequestSendingTask(final ClientRegistry clientRegistry, final LwM2mRequestSender delegateSender,
            final ClientStatusTracker clientStatusTracker, final MessageStore messageStore, final String endpoint) {
