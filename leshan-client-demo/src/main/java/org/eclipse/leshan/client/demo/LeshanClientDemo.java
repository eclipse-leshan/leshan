...
public class LeshanClientDemo {
    ...
    public static LeshanClient createClient(LeshanClientDemoCLI cli, LwM2mModelRepository repository) throws Exception {
        ...
        CoapsProtocolProvider customCoapsProtocolProvider = new CoapsProtocolProvider() {
            @Override
        ...
        endpointsBuilder.setCoapServerConfiguration(clientCoapConfig);
