 ...
 */
public class SandCEventServlet extends HttpServlet {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SandCEventServlet.class);
    ...
    private final SandCLeshanServer server;

    private final ClientRegistryListener clientRegistryListener = new ClientRegistryListener() {

        @Override
        public void registered(Client client) {
            String jClient = SandCEventServlet.this.gson.toJson(client);
            sendEvent(EVENT_REGISTRATION, jClient, client.getEndpoint());
        }

        @Override
        public void updated(Client clientUpdated) {
            String jClient = SandCEventServlet.this.gson.toJson(clientUpdated);
    ...
    public SandCEventServlet(SandCLeshanServer server, int securePort) {
        this.server = server;
    ...
    class ClientCoapListener implements CoapMessageListener {
        ...
        public void trace(CoapMessage message) {
            String coapLog = SandCEventServlet.this.gson.toJson(message);
