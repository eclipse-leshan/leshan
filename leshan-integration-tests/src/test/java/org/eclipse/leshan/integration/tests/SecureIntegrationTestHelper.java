...
public class SecureIntegrationTestHelper extends IntegrationTestHelper {
    ...
    // client certificate signed by manufacturer CA's with a good CN (CN=urn:dev:ops:32473-IoT_Device-K1234567,O=Manufacturer)
    ...
    public void createX509CertClient(X509Certificate[] clientCertificate, PrivateKey privatekey, List<Certificate> clientTrustStore,
    ...
    public void createServerWithX509Cert(X509Certificate serverCertificateChain[], PrivateKey privateKey, Boolean serverOnly) {
        createServerWithX509Cert(serverCertificateChain, privateKey, this.trustedCertificates, serverOnly);
    }

    public void createServerWithX509Cert(X509Certificate serverCertificateChain[], PrivateKey privateKey, Certificate[] trustedCertificates, Boolean serverOnly) {
