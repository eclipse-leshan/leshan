...
public class ObjectResource extends LwM2mClientCoapResource implements ObjectListener {
    ...
    public ObjectResource(int objectId, ServerIdentityExtractor identityExtractor, LwM2mRequestReceiver requestReceiver,
            ClientEndpointToolbox toolbox) {
        super(Integer.toString(objectId), identityExtractor);
