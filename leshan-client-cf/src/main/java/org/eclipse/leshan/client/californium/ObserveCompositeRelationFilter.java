...
class ObserveCompositeRelationFilter implements ObserveRelationFilter {
     ...
     * @param resourceIds the list of resource identifiers.
     */
    public ObserveCompositeRelationFilter(LwM2mDecoder decoder, int objectId, int instanceId, int... resourceIds) {
        this.decoder = decoder;
        paths = new ArrayList<>();
        for (int resourceId : resourceIds) {
            paths.add(new LwM2mPath(objectId, instanceId, resourceId));
        }
    }
