...
public class LeshanBootstrapServerDemo2 {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LeshanBootstrapServerDemo2.class);
    ...
    public static void createAndStartServer(String webAddress, int webPort, String localAddress, int localPort,
        ...
        WildCardBootstrapStoreImpl bsStore = new WildCardBootstrapStoreImpl(configFilename);
        ...
        root.setContextPath("/");
        root.setResourceBase(LeshanBootstrapServerDemo2.class.getClassLoader().getResource("webapp").toExternalForm());
