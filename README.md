...
```
wget -O leshan-demo-server.jar 'https://download.eclipse.org/leshan/2.x/lastSuccessfulBuild/artifact/leshan-demo-server.jar'
java -jar ./leshan-demo-server.jar
```
Get and run the last binary of our demo **client** :
```
wget -O leshan-demo-client.jar 'https://download.eclipse.org/leshan/2.x/lastSuccessfulBuild/artifact/leshan-demo-client.jar'
