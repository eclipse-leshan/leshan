...
```
wget https://download.eclipse.org/leshan/1.x/lastSuccessfulBuild/artifact/leshan-server-demo.jar
java -jar ./leshan-server-demo.jar
```
Get and run the last binary of our demo **client** :
```
wget https://download.eclipse.org/leshan/1.x/lastSuccessfulBuild/artifact/leshan-client-demo.jar
java -jar ./leshan-client-demo.jar
```
Get and run the last binary of our **bootstrap** demo server :
```
wget https://download.eclipse.org/leshan/1.x/lastSuccessfulBuild/artifact/leshan-bsserver-demo.jar 
