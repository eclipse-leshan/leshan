...
public class LwM2mTlsServer extends PSKTlsServer {
    ...
    public TlsCredentials getCredentials() throws IOException {
        System.out.println(Arrays.toString(getCertificateRequest().getCertificateTypes()));
        Certificate cert = null;
        PublicKey publicKey = null;
        short clientCertificateType = context.getSecurityParametersHandshake().getClientCertificateType();
        System.out.println(clientCertificateType);
